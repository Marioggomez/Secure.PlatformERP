...
/* Endurecimiento de CRUD operativos restantes con SESSION_CONTEXT */
...
BEGIN
    ...
    SET [id_instancia_aprobacion] = @id_instancia_aprobacion,
        ...
        [fecha_utc] = @fecha_utc
    WHERE [id_accion_instancia_aprobacion] = @id_accion_instancia_aprobacion AND [id_empresa] = @ctx_id_empresa;
...
BEGIN
    ...
    WHERE [id_excepcion_sod] = @id_excepcion_sod AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [activo] = @activo
    WHERE [id_instancia_aprobacion] = @id_instancia_aprobacion AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_perfil_aprobacion] = @id_perfil_aprobacion AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_regla_sod] = @id_regla_sod AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_auditoria_autorizacion] = @id_auditoria_autorizacion AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [fecha_utc] = @fecha_utc,
        ...
        [agente_usuario] = @agente_usuario,
        [solicitud_id] = @solicitud_id
    WHERE [id_auditoria_evento_seguridad] = @id_auditoria_evento_seguridad AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [agente_usuario] = @agente_usuario,
        [fecha_utc] = @fecha_utc
    WHERE [id_auditoria_reinicio_mesa_ayuda] = @id_auditoria_reinicio_mesa_ayuda AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_error_aplicacion] = @id_error_aplicacion AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [correlation_id] = @correlation_id,
        ...
        [fecha] = @fecha,
        [id_tenant] = @id_tenant
    WHERE [id_operacion_api_log] = @id_operacion_api_log AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_empresa] = @id_empresa AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_grupo_empresarial] = @id_grupo_empresarial AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_empresa] = @id_empresa,
        [activo] = @activo,
        [creado_utc] = @creado_utc
    WHERE [id_grupo_empresarial] = @id_grupo_empresarial AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_relacion_empresa] = @id_relacion_empresa AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_unidad_organizativa] = @id_unidad_organizativa AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_configuracion_empresa] = @id_configuracion_empresa AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_tenant] = @id_tenant AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [activo] = @activo
    WHERE [id_tenant_feature] = @id_tenant_feature AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_asignacion_rol_usuario] = @id_asignacion_rol_usuario AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_configuracion_canal_notificacion] = @id_configuracion_canal_notificacion AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [conteo] = @conteo
    WHERE [id_contador_rate_limit] = @id_contador_rate_limit AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_deber] = @id_deber AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_excepcion_permiso_usuario] = @id_excepcion_permiso_usuario AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_filtro_dato_usuario] = @id_filtro_dato_usuario AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [timeout_inactividad_min_override] = @timeout_inactividad_min_override,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_empresa] = @id_empresa AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_politica_ip] = @id_politica_ip AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_privilegio] = @id_privilegio AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_rol] = @id_rol AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    WHERE [id_sesion_usuario] = @id_sesion_usuario AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_usuario_empresa] = @id_usuario_empresa AND [id_tenant] = @ctx_id_tenant AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        [id_empresa] = @id_empresa
    WHERE [id_usuario_scope_empresa] = @id_usuario_scope_empresa AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tenant] = @id_tenant,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_usuario] = @id_usuario AND [id_tenant] = @ctx_id_tenant;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_usuario] = @id_usuario,
        ...
        [creado_utc] = @creado_utc,
        [actualizado_utc] = @actualizado_utc
    WHERE [id_usuario_unidad_organizativa] = @id_usuario_unidad_organizativa AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
...
BEGIN
    ...
    SET [id_tercero] = @id_tercero,
        ...
        [id_empresa] = @id_empresa,
        [activo] = @activo
    WHERE [id_tercero_rol] = @id_tercero_rol AND [id_empresa] = @ctx_id_empresa;
    SELECT @@ROWCOUNT AS filas_afectadas;
END
GO
