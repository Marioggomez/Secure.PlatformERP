...
/*
    Hotfix:
    - No bloquear logins/endpoints publicos por ausencia de SESSION_CONTEXT.
    - Si hay contexto en sesion lo prioriza; si no, usa parametro recibido (nullable).
*/
